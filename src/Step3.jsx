...
function Experience({ onNext, data }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit" style={{position:'absolute',marginlft:'70px', backgroundColor: 'blue',padding:'5px',color: 'white', marginLeft: '20px',margintop:'170px', borderRadius: '5px', border: 'blue' }}>Next Step</button>
        </div>
      </div>
    </form>
  );
