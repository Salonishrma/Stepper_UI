...
function Experience({ onNext, data }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit" style={{position:'absolute', backgroundColor: 'blue',padding:'5px',color: 'white', marginLeft: '20px',margintop:'80px', borderRadius: '5px', border: 'blue' }}>Next Step</button>
        </div>
      </div>
    </form>
  );
